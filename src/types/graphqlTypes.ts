...
export enum ContentfulProjectFieldsEnum {
  ...
  MainImageLocalFileChildImageSharpId = 'mainImage___localFile___childImageSharp___id',
  MainImageLocalFileChildImageSharpChildren = 'mainImage___localFile___childImageSharp___children',
